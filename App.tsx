        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              ...
              { title: "Zoom! Whitening", desc: "4 shades whiter in just one 60-minute session.", img: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&q=80&w=800", badge: "Whitening" }
            ].map((item, idx) => (
